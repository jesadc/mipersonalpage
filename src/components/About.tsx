  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-4xl sm:text-5xl font-extrabold mb-10 sm:mb-12 text-center text-gray-800">Sobre mí</h2>
        <div className="flex flex-col items-center mb-8">
          <div className="w-36 h-36 sm:w-48 sm:h-48 rounded-full border-4 sm:border-8 p-1 bg-gradient-to-r from-green-400 to-blue-500 shadow-xl mb-6 sm:mb-8">
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-base sm:text-lg text-blue-500 space-y-2">
